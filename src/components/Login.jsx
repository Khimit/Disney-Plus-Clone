...
const Login = () => {
  return (
    <div
      ...
      className="bg-cover bg-top bg-no-repeat h-screen w-screen"
    >
      <div className="h-screen w-full flex justify-center items-center">
        <div className="flex flex-col items-center">
          <img src={logo1} alt="Logo 1" />
          <div className="bg-blue-700 w-2/4 h-16 m-3 rounded-md cursor-pointer hover:bg-blue-600 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  duration-300">
